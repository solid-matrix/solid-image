...
public enum Photometric : ushort
{
    ...
    /// <summary>
    ///     RGB color model, a color is described as a combination of the three primary colors of light (red, green, and blue)
    ///     in particular concentrations.
    /// </summary>
    RGB = 2,

    /// <summary>
    ///     Palette color model, a color is described with a single component.
    ///     The value of the component is used as an index into the red, green and blue curves in the ColorMap field to
    ///     retrieve an RGB triplet that defines the color.
    /// </summary>
    RGBPalette = 3,
